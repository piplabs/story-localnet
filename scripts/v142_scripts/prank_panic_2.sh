...
# The script performs: create validator with 110,000 IP -> stake 1,025 IP -> unstake 110,000 IP + 1 IP
# it will panic in this case since the remaining delegation (110,000 + 1,025 - 110,001 = 1024) is NOT less than min_delegation
...
MIN_STAKE=${MIN_STAKE:-1025000000000000000000}            # 1,025 IP (ether units)
