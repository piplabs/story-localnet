...
# 2. self-undelegation > 0.5 total delegation 
# what happen if remaining delegation < min_delegation?
...
UNSTAKE_AMOUNT=${UNSTAKE_AMOUNT:-108977000000000000000000}   # 108,977 IP (ether units)
