...
# The script performs: create validator with 105,000 IP -> unstake 101,024 IP 
# will panic since the remaining delegation (105,000 - 101,024 = 3,976) is NOT less than min_delegation
...
CREATE_AMOUNT=${CREATE_AMOUNT:-105000000000000000000000}   # 105,000 IP (ether units)
UNSTAKE_AMOUNT=${UNSTAKE_AMOUNT:-101024000000000000000000}   # 101,024 IP (ether units)
...
echo
echo "=== Step 2: unstake ${UNSTAKE_AMOUNT} ==="
